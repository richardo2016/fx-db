...
exports.singleton = null;
exports.settings = null;
exports.Property = null;
exports.Settings = null;
exports.ErrorCodes = null;
exports.Text = null;
...
exports.use = function (connection, proto, opts, cb) {
    ...
    try {
        ...
        const settings = new exports.Settings.Container(exports.settings.get('*'));
...
exports.connect = function (opts, cb) {
    ...
    try {
        ...
        var settings = new exports.Settings.Container(exports.settings.get('*'));
...
exports.connectSync = util.sync(exports.connect);
